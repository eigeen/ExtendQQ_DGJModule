...
namespace ExtendQQ_DGJModule
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow(ConfigService config, QQSession session, HttpClientv2 client)
        {
            InitializeComponent();
            _config = config;
            _session = session;
        ...
        public void OnLoginStatusChanged()
        {
            ...
            {
                Title = _session.LoginStatus
                    ? $"管理界面 - 本地QQ音乐模块    状态:已使用cookies登录"
                    : "管理界面 - 本地QQ音乐模块    状态:未登录";
            }
            else
            {
        ...
        //     {
        //         if (MessageBox.Show("确定要注销喵？", "管理界面 - 本地QQ音乐模块", MessageBoxButton.YesNo, MessageBoxImage.Question) ==
        ...
        //     else
        //     {
        //         MessageBox.Show("还没登录喵~", "管理界面 - 本地QQ音乐模块", 0, MessageBoxImage.Warning);
        //     }
        // }
        ...
        //                     MessageBox.Show("登录成功OvO", "管理界面 - 本地QQ音乐模块", 0, MessageBoxImage.Asterisk);
        //                 }
        //                 catch (Exception e)
        //                 {
        //                     MessageBox.Show($"无法获取用户信息TvT\r\n{e}", "管理界面 - 本地QQ音乐模块", 0, MessageBoxImage.Error);
        //                     break;
        //                 }
        //
        //                 OnLoginStatusChanged();
